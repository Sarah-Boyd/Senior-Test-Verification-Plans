/*
 * File:   ADC_Sample_Rate_Add_In.c
 * Author: sarah
 *
 * Created on March 17, 2024, 11:08 AM
 */
...
volatile float ADC_Data_o7[250];
volatile float ADC_Data_o8[250];
int ind_count7 = 0;
int ind_count8 = 0;
