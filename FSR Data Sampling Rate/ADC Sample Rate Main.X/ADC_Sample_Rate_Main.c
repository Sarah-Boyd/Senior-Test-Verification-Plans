/*
 * File:   ADC_Sample_Rate_Main.c
 * Author: sarah
 *
 * Created on March 17, 2024, 11:01 AM
 */
...
volatile float ADC_Data_o5[250];
volatile float ADC_Data_o6[250];
int ind_count6 = 0;
int ind_count5 = 0;
...
void __attribute__((interrupt, no_auto_psv)) _T1Interrupt(void) {
    ...
    ADCON3Lbits.SWCTRG = 1;//Enable ADC Read - this causes ADC interrupts to happen
